...
from sglang import AzureOpenAI, set_default_backend
...
class TestOpenAIBackend(unittest.TestCase):
    ...
    def setUp(self):
        ...
        if cls.backend is None:
            ...
            cls.backend = AzureOpenAI("gpt-35-turbo-instruct", **backend_kwargs)
            cls.chat_backend = AzureOpenAI("gpt-35-turbo", **backend_kwargs)
            cls.chat_vision_backend = AzureOpenAI("gpt-4-vision-preview", **backend_kwargs)
